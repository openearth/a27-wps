...
select st_x(st_transform(l.geom,4326)) as longitude_wgs84, st_y(st_transform(l.geom,4326)) as latitude_wgs84, l.locatie_id, string_agg(p.peilfilter_id::text, ',') as peilfilterids, l.bron_id, b.dataleverancier
from gws.locatie l 
